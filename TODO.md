...
## 6. Launch plumbing
- [ ] Domain: point codehives.se at GitHub Pages (workflow and CNAME in place; DNS A/AAAA records and www CNAME at the registrar, then Settings → Pages → custom domain, enforce HTTPS)
