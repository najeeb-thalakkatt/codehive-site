...
export default function Nav() {
  return (
    ...
    <header style={{ position: "fixed", left: 0, right: 0, top: 0, paddingTop: "env(safe-area-inset-top, 0px)", paddingBottom: 36, zIndex: 20, pointerEvents: "none", background: "linear-gradient(var(--bg0) 45%, transparent)" }}>
