  ...
  return (
    <>
      ...
      <main className="wrap" style={{ paddingTop: 140, paddingBottom: 96 }}>
        ...
        <p style={p}>If we add a form, a booking tool or anything else that collects data, this page changes first. Last updated 2026-09-21.</p>
